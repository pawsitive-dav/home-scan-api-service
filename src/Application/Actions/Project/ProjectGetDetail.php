...
class ProjectGetDetail extends MainAction
{
    protected function action(): Response
    {
        ...
        $sqlQuery = "SELECT
                        ...
                        JSON_OBJECT(
                            ...
                            'member_role', mi_project_owner.member_role
                        ) AS project_owner,
                        JSON_OBJECT(
                            ...
                            'member_role', mi_checker_supervisor.member_role
                    ...
                    LEFT JOIN member_info mi_created_by ON pd.created_by = mi_created_by.account_id
