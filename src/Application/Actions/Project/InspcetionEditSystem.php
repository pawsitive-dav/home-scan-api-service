...
class InspcetionEditSystem extends MainAction
{
    protected function action(): Response
    {
        $input = $this->getFormData();

        $allKeys = ["project_id", "inspection_id", "system_id", "system_name"];
        $requiredKeys = ["project_id", "inspection_id", "system_id", "system_name"];
        ...
        $sqlQuery = "UPDATE inspection_system
                    SET
